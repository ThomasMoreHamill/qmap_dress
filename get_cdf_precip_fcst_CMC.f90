! FILE: get_cdf_precip_fcst_CMC.f90
!  f2py -c -m get_cdf_precip_fcst_CMC get_cdf_precip_fcst_CMC.f90
! ================================================================================

SUBROUTINE get_cdf_precip_fcst_CMC(nthresh, nmembers, nya, nxa, nsuppmax, &
...
RETURN
END SUBROUTINE get_cdf_precip_fcst_CMC
