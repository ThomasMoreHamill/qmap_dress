SUBROUTINE sgolay_smooth(nx, ny, ideterministic, z, ihavedata, weights, window_size, order, istat)
...
! ---- last step:  re-set the smoothed values to missing over water, and make sure 
!      if the input data is probability data, the results are bounded by 0 and 1.
